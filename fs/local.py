...
from .utils import copyfile, makedirs, move, remove, tmp_fname #dvc原始代码
from .utils import makedirs, move, remove, tmp_fname
...
class FsspecLocalFileSystem(fsspec.AbstractFileSystem):
    ...
    def put_file(self, lpath, rpath, callback=None, **kwargs):
        ...
        # copyfile(lpath, tmp_file) # zhoufang 改进版本，用linux原生copyfile() #from shutil import copyfile
        copyfile(lpath, tmp_file, callback=callback) #dvc源码的原始代码copyfile #20221202
